...
APlatinumA3Character::APlatinumA3Character()
{
...
void APlatinumA3Character::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void APlatinumA3Character::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
...
void APlatinumA3Character::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
